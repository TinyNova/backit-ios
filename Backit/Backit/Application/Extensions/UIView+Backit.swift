...
extension UIView {
    ...
    /**
     ...
     In order for this to work correctly you must set the File Owner's Custom Class property to the respective class type.
     Make (keep) the root view inside the xib a `UIView` (the default).
     */
    @discardableResult
    func fromNib<T : UIView>() -> T? {
        ...
        // I'm leaving this here as this "works" too. But the other method is probably more robust.
